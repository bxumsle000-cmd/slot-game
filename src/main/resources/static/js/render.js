...
const POOL = ["Blank","Cherry","Lemon","BAR","Seven","Wild"];
...
// 播放轉動動畫：
//   帶子結構 = [最終結果 3 格] + [填充符號 N 格]
//   起點先無動畫地位移到只看得到填充區尾端，再滑回 translateY(0)，
//   帶子往下轉、停住時視窗剛好是結果 3 格。
// 回傳 Promise，5 輪全部停輪後才 resolve（game2.js 等這個才結算畫面）。
